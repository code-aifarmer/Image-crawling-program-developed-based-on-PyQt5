...
"}*/")
        ...
        self.radioButton_google.setVisible(False)
        ...
        self.radioButton_chrome_headless.setVisible(False)
        ...
        self.radioButton_chrome.setVisible(False)
        ...
        self.radioButton_phantomjs.setVisible(False)
        ...
        self.checkBox_face_only.setVisible(False)
        ...
        self.checkBox_safe_mode.setVisible(False)
        ...
        self.widget_proxy.setVisible(False)
        ...
        self.radioButton_http.setVisible(False)
        ...
        self.radioButton_socks5.setVisible(False)
        ...
        self.lineEdit_proxy.setVisible(False)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_3.setTitle(_translate("MainWindow", "任务状态"))
        self.label_4.setText(_translate("MainWindow", "计时:"))
        self.label_time_elapsed.setText(_translate("MainWindow", "00:00:00"))
        self.label_2.setText(_translate("MainWindow", "总任务数:"))
        self.label_3.setText(_translate("MainWindow", "当前任务:"))
        ...
        self.lineEdit_keywords.setPlaceholderText(_translate("MainWindow", "输入查询关键字，多个关键字用逗号分割"))
        self.checkBox_from_file.setText(_translate("MainWindow", "&选择本地文件:"))
        ...
        self.lineEdit_path2file.setPlaceholderText(_translate("MainWindow", "本地文件"))
        self.pushButton_load_file.setText(_translate("MainWindow", "..."))
        self.label_7.setText(_translate("MainWindow", "&输出:"))
        self.lineEdit_output.setToolTip(_translate("MainWindow", "输出文件夹."))
        self.lineEdit_output.setStatusTip(_translate("MainWindow", "输出文件夹."))
        self.lineEdit_output.setText(_translate("MainWindow", "./download_images"))
        self.lineEdit_output.setPlaceholderText(_translate("MainWindow", "输出文件夹."))
        ...
        self.label_6.setText(_translate("MainWindow", "关键字最大下载数"))
